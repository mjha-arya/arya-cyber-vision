...
const AboutUs = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className=" px-4 sm:px-10 lg:px-12 pt-[12px] pb-12">
        {/* Hero - Founder Bio */}
        <section className="mb-4">
          <div className="grid md:grid-cols-[2fr_1fr] gap-8 items-center">
            ...
            <div className="text-center ml-[286px] -mt-7">
              <div className="w-[340px] h-[570px] rounded-full overflow-hidden border-4 border-primary mx-auto mb-4 mt-[25px]">
                <img 
        ...
        {/* Story Section */}
        <section className="mb-2 -mt-[280px]">
        ...
        {/* Impact & Trust */}
        <section className="mb-4 mt-[130px]">
